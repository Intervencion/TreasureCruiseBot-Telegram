module.exports = {
    ...
    1831: {//6* Judge
        captain: "Increase the rate of PSY orbs, reduces damage recieved by 15%, boosts the HP of all characters by 1.25x and if there is a [STR], [DEX], [QCK], [PSY], and [INT] characters in your crew, boosts ATK of all characters by 3.9x if they have a matching orb, by 2.25x otherwise",
    ...
    1873: {//Kyros RR
        captain: "2.5x ATK to Slasher and Striker characters and boost HP by 1.25 to Slasher and Striker characters.",
        sailor: "2x attack addition on tap",
        special: "30x attack damage in str damage to one enemy, recover two turns of despair/chain, boosts slashers attack by 1.75x for 3 turns",
        limit: "This character has a limit break path",
        specialName: "The Forefront Reclaiming His Country"
    ...
    1875: {//Violet RR
        captain: "1.5x ATK to all characters and 2.5x Belis",
        sailor: "Avoid special seal",
        special: "Change meat/block/empty/tandem to matching orbs, removes two turns of paralyze/special seal, adds 0.5x to chain multiplier for one turn",
        limit: "This character has a limit break path",
        specialName: "Violent Interrogation of Passion"
    ...
    1877: {//Rebecca RR
        captain: "2.25x slashers attack and 15% damage reduction",
        sailor: "Treat str orbs as matching",
        special: "50000 fixed damage to one enemy, recover 5 turns of chain lock/cap, change neighbouring orbs to matching",
        limit: "This character has a limit break path",
        specialName: " Strike of Determination"
    },
    1878: {//Bartolomeo Raid
        captain: "ATK 1.5x, reduce incoming damage by 10%, boost ATK of crew by 2.25x on the turn that \"Barrier Rush\" is used",
        special: [
            {
                "description": "For 2 turns reduce damage over 5000 damage by a significant large amount from each enemy, recover 20% of max HP, reduce 5 turns of ATK up and enrage on the enemy",
                "cooldown": [ 28, 13 ]
            },
            {
                "description": "For 2 turns reduce damage over 3000 damage by a significant large amount from each enemy, recover 50% of max HP, reduce 5 turns of end of turn damage, ATK up, enrage and protection from defeat on the enemy",
                "cooldown": [ 33, 18 ]
            }
        ],
        specialNotes: "#{stages}",
        specialName: "Barrier Rush"
    },
    1879: {//Bartolomeo Raid
        captain: "ATK 2.25x, HP 1.35x, reduce incoming damage by 10%, boost ATK of crew by 2.75x on the turn that \"Barrier Rush\" is used",
        special: [
            {
                "description": "For 2 turns reduce damage over 5000 damage by a significant large amount from each enemy, recover 20% of max HP, reduce 5 turns of ATK up and enrage on the enemy",
                "cooldown": [ 28, 13 ]
    ...
    1880: {//Hody Jones
        captain: "Reduce CD by 2 at the start of the adventure, boost the HP of the crew depending on how many Powerhouse Characters are on the team with a max of 2x, when the crew has 6 Powerhouse characters boost ATK by 3.25x",
        captainNotes: "Hody's HP boost is dependent on how many Powerhouse characters are in your crew. With 6 Powerhouse characters, the boost is 2x, with 5 the boost is 1.5x, with 4 the boost is 1.4x, with 3 the boost is 1.3x, with 2 the boost is 1.2x, and with 1 the boost is 1.1x.",
        special: [
            {
                "description": "INT damage to all enemies that will ignore damage negating abilities and barriers, reduce CD of Powerhouse characters by 1, for 1 turn reduce incoming damage by 60%",
                "cooldown": [ 12, 7 ]
            },
            {
                "description": "Extra large INT damage to all enemies that will ignore damage negating abilities and barriers, reduce CD of Powerhouse characters by 2, for 1 turn reduce incoming damage by 90%",
                "cooldown": [ 21, 16 ]
            }
        ],
        specialNotes: "#{ignoreBarrier}<br>#{stages}",
    ...
    1881: {
        ...
        special: [
            {
                "description": "Deals 30% of the damage dealt in the previous turn from normal attacks as typeless damage to all enemies",
                "cooldown": [ 18, 12 ]
            },
            {
                "description": "Deals 60% of the damage dealt in the previous turn from normal attacks as typeless damage to all enemies",
                "cooldown": [ 24, 18 ]
            }
        ],
